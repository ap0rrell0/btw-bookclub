        ...
        <div style={{ padding: "14px 12px 0" }}>
          ...
          <div style={{ display: "flex", gap: 6, flexWrap: "wrap", marginBottom: 12 }}>
            {["All", ...STATUS_OPTIONS, "No Status"].map(s => {
              ...
              return (
                <button key={s} onClick={() => setFilterStatus(s)} style={{ padding: "5px 12px", borderRadius: 20, fontSize: 12, cursor: "pointer", fontFamily: "Georgia,serif", fontWeight: active ? "bold" : "normal", border: "1.5px solid " + (active && sm ? sm.border : active ? C.wineRed : "#D4A8B8"), background: active && sm ? sm.bg : active ? C.wineRed : "#fff", color: active && sm ? sm.text : active ? "#fff" : C.mutedText }}>
                  {s}
                </button>
              );
            })}
